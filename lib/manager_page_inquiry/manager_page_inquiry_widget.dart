...
class ManagerPageInquiryWidget extends StatefulWidget {
  const ManagerPageInquiryWidget({Key? key}) : super(key: key);

  @override
  _ManagerPageInquiryWidgetState createState() =>
      _ManagerPageInquiryWidgetState();
}

class _ManagerPageInquiryWidgetState extends State<ManagerPageInquiryWidget> {
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(0, 15,
                                                                    0, 0),
                                                        child: Text(
                                                          '상담내용 / 인생에는 적극적인 의미의 즐거움, 행복이란 것이존재하지 않는다. 다만 고통과 권태가 있을 뿐이다.파티와 구경거리와 흥분되는 거움, ',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyText1,
                                                        ),
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(0, 15,
                                                                    0, 0),
                                                        child: Text(
                                                          '상담내용 / 인생에는 적극적인 의미의 즐거움, 행복이란 것이존재하지 않는다. 다만 고통과 권태가 있을 뿐이다.파티와 구경거리와 흥분되는 일들로 가득차 보이는 세상살이도 그 이면의 실상을 알고 보면 고통과 권태 사이를 왔다갔다 하는 단조로운',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyText1,
                                                        ),
